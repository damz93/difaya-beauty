...
<html>
	<head>
		<title>Data Pemasukan - DIFAYA BEAUTY | Effortless Care For Priceless You</title>
	...
	<body>
		<?php 
			...
			?>
		<h1 align='center' style="background-color:#9e7400;color:#FFFFFe">DATA PEMASUKAN</h1>
		...
		<table id="tabel2" align="center" width="100%" border="0" cellpadding="0" cellspacing="1">
			<tr>
				...
				<td align="right"><button type="button" class="btn btn-danger"><a href="input-pemasukan" style="color:#FFFFFe"> + Tambah Pemasukan </a></button></td>
			</tr>
			<tr>
		...
		<table id="tabel1" class="table table-hover" border="1" cellpadding="0" cellspacing="1">
			...
			<tr align="center">
				...
				<?php } ?>
				<td>			
					<a href='edit-pemasukan?id=<?php echo $kod_pem; ?>' title="Edit Pemasukan"><img src="img/edit.png" class="img-responsive" height="100%"></a>	| 					
					<a href='delete-pemasukan?id=<?php echo $kod_pem; ?>' title="Hapus Pemasukan" onclick="return confirm('Apakah yakin ingin menghapus?')"><img src="img/delete.png" height="100%" ></a>					
				</td>
			</tr>
			<?php 
				}
