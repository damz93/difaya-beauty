<?php
   include 'koneksi.php';
   $kode_pengeluaran         = $_GET['id'];
   //$pem = mysqli_query($koneksi,"select * from t_pengeluaran where KODE_PENGELUARAN='$kode_pengeluaran'");
   $pem = mysqli_query($koneksi,"select * from t_pengeluaran where KODE_PENGELUARAN='$kode_pengeluaran'");
...
<html>
   <head>
      ...
      <title>Edit Pengeluaran - DIFAYA BEAUTY | Effortless Care For Priceless You</title>
   ...
   <div class="bg">
	...
	?>
            <h1 align='center' style="background-color:#9e7400;color:#FFFFFe">EDIT PENGELUARAN</h1>
     ...
     <br>  
      ...
      <br>
	  <div class='container'>
         <form method="post" action="update-pengeluaran" onsubmit="return cek_dulu();" autocomplete="off" enctype="multipart/form-data">
		 <div class="form-group">
			 <div class="table-responsive">
				<table class="table" border="0" cellpadding="2" cellspacing="2" align=center>
				   <tr>
					  <th>Kode Pengeluaran</th>
					  <th colspan="2"><input class="form-control form-control-sm" readonly type="text" name="kode_pengeluaran" id="kode_pengeluaran"  value="<?php echo $kode; ?>"></th>
				   </tr>		 
					<tr>
						<th>Sumber</th>
						<th colspan="2">
							<select autofocus class="form-control form-control-sm" name="kategori" id="kategori">	
								<option value="GAJI" <?php if($sumber=="GAJI") echo 'selected="selected"'; ?> >Gaji</option>
								<option value="MARKETING" <?php if($sumber=="MARKETING") echo 'selected="selected"'; ?> >Marketing</option>
								<option value="OPERASIONAL" <?php if($sumber=="OPERASIONAL") echo 'selected="selected"'; ?> >Operasional</option>
								<option value="PRODUKSI" <?php if($sumber=="PRODUKSI") echo 'selected="selected"'; ?> >Produksi</option>
							</select>
						</th>
					</tr>
				   <tr>
